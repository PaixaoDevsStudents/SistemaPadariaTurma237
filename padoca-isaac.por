programa
{
	...
	{	
		...
		//menu de opções
		Menu( numDeVet, vetsrc, matCaixa, id, vetDeNum, saldoCaixa)
	}
	//back end
	...
	funcao pesquisarProduto(inteiro id,cadeia caminho[], inteiro vetDeNum[], real saldoCaixa, real matCaixa[][], cadeia vetorProd[],cadeia vetorVend[],inteiro posicao){
          	...
          	se(vetDeNum[0] != 0){
				...
				faca{
					...
					se(opcaoInterna == j){	
						...
						senao{
							realizarVenda( vetorProd, matCaixa, vetorVend, caminho, linhaOriginal, posicao,vetDeNum,saldoCaixa)
							saidaLoop = 1
						}
					}
	...
	funcao Menu(inteiro numDeVet[],cadeia vetsrc[], real matCaixa[][], inteiro id, inteiro vetDeNum[], real saldoCaixa, cadeia vetorProd[], cadeia vetorVend[],inteiro posicao)
          ...
          enquanto (saida) {
			...
			numDeVet[2] = totalProdutos(vetsrc[3])
               escolha(botao){
				...
				caso 2:
					//realizar vendas
					saldoCaixa = fluxoCaixa(matCaixa)
					pesquisarProduto( id, vetsrc, numDeVet, saldoCaixa, matCaixa)
				pare
				caso 3:
 ...
 * 
 * @POSICAO-CURSOR = 21428; 
 * @DOBRAMENTO-CODIGO = [61, 67, 368, 379, 479, 543, 577, 587, 618, 637, 670, 709, 727, 751, 786, 818, 840, 895, 893, 1075, 991, 1090, 1106, 1153, 1156, 1178];
 * @PONTOS-DE-PARADA = ;
