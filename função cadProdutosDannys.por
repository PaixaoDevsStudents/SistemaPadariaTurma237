programa
{
	...
	{	
		...
		//variaveis
		inteiro opcao, arquivo, vetCod[5], vetQntProduto[5], tipoProduto =0, vetMenorPeso[5]
		real saldoCaixa=0.0, vetCusto[5], vetValorProd[5]
		cadeia vetsrc[5], vetNome[5],nomeProduto,valorProd,qntProduto,custo,menorPeso, vetTipo[5]
		...
		escreva("Digite o nome do produto para cadastrar :\n-->")//saída de daos para direcionar o usuario
          ...
          nomeValido = falso // Defini nomeValido como falso
           ...
           faca{
           escreva("O produto será vendido na unidade ou no quilo?\nDigite:\n1 - Para unidade  \n2 - Para kg:\n-->")
             leia(tipoProduto)
             tipoProdutoInt = tipoProduto
             se(tipoProduto != 1 e tipoProduto != 2){
             	escreva("Tipo do produto invalido!\n")
             	}
              }enquanto(tipoProdutoInt != 1 e tipoProduto != 2)
               se(tipoProdutoInt == 2){
               	 vetTipo[l] = "Kg"
                    faca{
				 escreva("Digite o menor peso do produto : \n(ex: 50 == 50 gramas)\n-->")//saída de daos para direcionar o usuario
			     	leia (menorPeso)
				 se(menorPeso==""){
		 			escreva("Digite um valor\n")
				 }
				 se(typ.cadeia_e_inteiro(menorPeso,10)==falso){// Verifica se a entrada é um número real
		 			escreva("Por favor Digite o valor inteiro do Produto\n")
		 			}
				 senao{
		 			vetMenorPeso[l]=typ.cadeia_para_inteiro(menorPeso,10)	 // Converte a entrada para um número real e armazena no vetor    
          	   } 
               	
               	}enquanto(vetMenorPeso[l]<=0)
               }
               senao{
               	 vetTipo[l] = "Uni"
               	}
           faca{
		 escreva("Digite o valor do produto por unidade ou Kg :\n-->")//saída de daos para direcionar o usuario
			     leia (valorProd)
		 se(valorProd==""){
		 	escreva("Digite um valor\n")
		 }
		 ...
		 senao{
           ...
           faca{    
		  escreva(" Digite a quantidade em estoque por unidade ou Kg: \ncaso o produto seja vendido em kg informe a quantidade em gramas\n (ex: 1000 == 1kg)\n--> ")//saída de daos para direcionar o usuario
  		         leia(qntProduto)
  		         se(qntProduto==""){
  		         	escreva("Digite um valor\n")
  		         }
           ...
           faca{
           escreva(" Digite o custo do Produto por unidade ou Kg:\n-->")//saída de daos para direcionar o usuario
          	   leia(custo)
          	   se(custo==""){
          	   	escreva("Digite um valor\n")
          	   }
			...
			se(vetCod[i]  == utl.sorteia(100, 300)){
				vetCod[i] = utl.sorteia(100, 300)
				}
		...
		para (inteiro l=0;l<7;l++){
      	...
      	escreva("\n")
      	para (inteiro  l=0;l<5;l++){
      		escreva("\t",vetNome[l],"|\t       ",vetCod[l],"|\t        ",vetTipo[l],"|\t          ",vetValorProd[l],"|\t         ",vetQntProduto[l],"|\t         ",vetCusto[l],"|\t        ",vetMenorPeso[l],"|\n")
      	}
	...
	funcao real calcularJuros(real valorCobrarCliente){
     ...
     funcao real troco(real valorDinheiro,real valorCobrarCliente, real trocoCliente){
		...
		compraEmGramas = typ.inteiro_para_real(quantidadeCompraCliente * 1000) // converter Kg para gramas 
