programa
{
	...
	inteiro ImgMenu = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/menu/menu_programa1.png")
     //Login e Senha
     inteiro ImgAcesso = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/relatorio/relatorio_vendas.png")
     inteiro ImgAcesso = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/relatorio/relatorio_vendas.png")
     inteiro ImgAcessoNegado = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/AcessoNegado.png")
     //cadastro
     inteiro ImgNome = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/Nome.png")
    	inteiro ImgCusto = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/Custo.png")
	inteiro ImgPesoUnitario = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/PesoUnitario.png")
	inteiro ImgPeso = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/Peso.png")
	inteiro ImgUnitario = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/Unitario.png")
	inteiro ImgQuantidade = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/Quantidade.png")
     inteiro ImgCadastroSucesso = grf.carregar_imagem("./midia/imagens/Telas do Front Padaria/CadastradoSucesso.png")
	...
	{	
		...
		real val_uni=0.0, val_custo=0.0, matCaixa[5][2]
	...
	funcao fechamentoCaixa(cadeia password, cadeia vetorProd[], cadeia vetorVend[],real matCaixa[][], cadeia caminho, cadeia linhaOriginal, inteiro posicao, inteiro vetDeNum[],cadeia vetsrc[]) {
		
	    // Solicita a verificação de acesso
	    verifAcess(password)
	    real saldoIni=fluxoCaixa(matCaixa)
	    ...
	    real saldoini=matCaixa[0][0], saldofini=matCaixa[0][1]
	    
	    gerarRelatorioVendas(vetsrc, matCaixa)
	...
	funcao vazio gerarRelatorioVendas(cadeia vetsrc[],real matCaixa[][]) {
	    // Abra o arquivo onde os dados de vendas estão armazenados
	    inteiro c = 0
	    cadeia caminho=vetsrc[5] 
	    cadeia dataHoraFechamento = Data()
 ...
 * 
 * @POSICAO-CURSOR = 820; 
 * @DOBRAMENTO-CODIGO = [62, 68, 369, 380, 480, 544, 557, 578, 588, 619, 638, 671, 710, 728, 752, 787, 819, 841, 868, 980, 1078, 1177, 1193, 1240, 1243, 1265];
 * @PONTOS-DE-PARADA = ;
