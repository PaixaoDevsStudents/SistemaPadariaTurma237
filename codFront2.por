...
//--------------------------------------------------------------------------------
	...
	*/
	...
	funcao realizarVendas(inteiro id, inteiro x, inteiro y,cadeia &texto){
		...
		escolha(id){
			caso 1: 
			inteiro ImgCodigo =  g.carregar_imagem()
			...
			pare 
			caso 2: 
			inteiro ImgCodInexistente  = g.carregar_imagem()
			...
			pare
			caso 3: 
			 inteiro  ImgQuantidade = g.carregar_imagem()
			 inteiro TelaQuantidade = g.redimensionar_imagem(ImgQuantidade, LarguraT, AlturaT, verdadeiro)
               g.desenhar_imagem(0, 0,  TelaQuantidade)
               g.desenhar_texto(x, y, texto+"_")
               g.liberar_imagem( TelaQuantidade)
			...
			pare
			caso 4: 
			 inteiro ImgQuantErrada = g.carregar_imagem()
			...
			pare
			caso 5:
               inteiro ImgFinalizarVend =g.carregar_imagem()
			...
			pare
			caso 6:
			inteiro ImgFormaPag = g.carregar_imagem()
			...
			pare
			caso 7:
               inteiro ImgTelaValor = g.carregar_imagem()
			...
			pare 
			caso 8:
               inteiro ImgTipoCartao = g.carregar_imagem()
			...
			pare
			caso 9:
			inteiro ImgPagamentoCred = g.carregar_imagem()
			...
			pare
		     caso 10:
		     inteiro ImgPagamentoDeb = g.carregar_imagem()
		     ...
		     pare 
		     caso 11:
		     inteiro ImgPix = g.carregar_imagem()
		     ...
		     pare 
		     caso 12:
		     inteiro ImgPixAprovad = g.carregar_imagem()
		     ...
		     pare 
		     caso 13:
               inteiro ImgTroco = g.carregar_imagem()
		     ...
		     pare 
		     caso 14:
               inteiro ImgPagAprovad = g.carregar_imagem()
