...
//--------------------------------------------------------------------------------
	...
	funcao realizarVendas(inteiro id, inteiro x, inteiro y,cadeia &texto){
		...
		escolha(id){
			caso 1: 
              TelaCodigo =  g.redimensionar_imagem( TelaCodigo=0, alturaT, larguraT, verdadeiro )
               g.desenhar_imagem(0, 0, TelaCodigo)
               g.desenhar_texto(x, y, texto+"_")
               g.liberar_imagem(TelaCodigo)
			pare 
			caso 2: 
               TelaQuantidade = g.redimensionar_imagem( TelaQuantidade, alturaT, larguraT, verdadeiro )
               g.desenhar_imagem(0, 0, TelaQuantidade)
               g.desenhar_texto(x, y, texto+"_")
               g.liberar_imagem(TelaQuantidade)
			pare
			caso 3: 
			TelaQuantErrada =  g.redimensionar_imagem(TelaQuantErrada , alturaT, larguraT, verdadeiro )
               g.desenhar_imagem(0, 0, TelaQuantErrada)
               g.desenhar_texto(x, y, texto+"_")
               g.liberar_imagem(TelaQuantErrada)
			pare
			caso 4: 
               TelaValor =  g.redimensionar_imagem( TelaValor , alturaT, larguraT, verdadeiro )
			...
			pare
			caso 5:
               TelaTroco =  g.redimensionar_imagem( TelaTroco, alturaT, larguraT, verdadeiro )
               g.desenhar_imagem(0, 0, TelaTroco)
               g.desenhar_texto(x, y, texto+"_")
               g.liberar_imagem(TelaTroco)
			pare
			caso 6:
               TelaFormaPag =  g.redimensionar_imagem(  TelaFormaPag , alturaT, larguraT, verdadeiro )
			...
			pare 
			caso 7:
		     TelaPagCart =  g.redimensionar_imagem(TelaPagCart , alturaT, larguraT, verdadeiro )
			...
			pare
		     caso 8:
		     TelaOpcCart =  g.redimensionar_imagem(TelaOpcCart , alturaT, larguraT, verdadeiro )
		     ...
		     pare 
		     caso 9:
              TelaPagCartConc =  g.redimensionar_imagem(TelaPagCartConc , alturaT, larguraT, verdadeiro )
               g.desenhar_imagem(0, 0,  TelaPagCartConc)
               g.desenhar_texto(x, y, texto+"_")
               g.liberar_imagem( TelaPagCartConc)
		     pare 
		     caso 10:
               TelaPagPix=  g.redimensionar_imagem(TelaPagPix , alturaT, larguraT, verdadeiro )
               g.desenhar_imagem(0, 0,  TelaPagPix)
               g.desenhar_texto(x, y, texto+"_")
               g.liberar_imagem(TelaPagPix)
		     pare 
		     caso 11:
              TelaPagPixConc =  g.redimensionar_imagem(TelaPagPixConc , alturaT, larguraT, verdadeiro )
